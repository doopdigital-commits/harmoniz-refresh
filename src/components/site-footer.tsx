    ...
    <footer id="contato" className="bg-primary text-primary-foreground mt-24">
      <div className="bg-secondary text-foreground">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid md:grid-cols-12 gap-10 items-center">
          ...
          <div className="md:col-span-8">
            <h3 className="font-display text-2xl md:text-3xl text-foreground">Comercializados exclusivamente pelo Veiling Holambra</h3>
            <p className="mt-4 text-foreground flex items-start gap-2">
              <MapPin className="h-4 w-4 mt-1 shrink-0" />
              Rodovia SP-107, km 27 — S/N, Zona Rural Veiling, Santo Antônio de Posse — SP
            </p>
            <div className="mt-3 flex flex-wrap gap-6 text-foreground text-sm">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 text-primary-foreground/85 max-w-sm leading-relaxed">
            Orquídeas com alma, cultivadas com amor em Mogi das Cruzes e entregues em todo o Brasil.
          </p>
        </div>
        <div className="md:col-span-4">
          <p className="uppercase tracking-[0.3em] text-xs text-primary-foreground/85 mb-4">Navegação</p>
        ...
        <div className="md:col-span-3">
          <p className="uppercase tracking-[0.3em] text-xs text-primary-foreground/85 mb-4">Redes</p>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-6 text-xs text-primary-foreground/75 flex flex-wrap justify-between gap-3">
