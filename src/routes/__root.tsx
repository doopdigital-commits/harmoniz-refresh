...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Harmoniz Orquídeas — Cultivadas com amor em Mogi das Cruzes" },
      { name: "description", content: "Produção de orquídeas de alta qualidade em Mogi das Cruzes (SP). Quase 10 gêneros, 30 mil m² de área produtiva e distribuição em todo o Brasil via Veiling Holambra." },
      { name: "author", content: "Harmoniz Orquídeas" },
